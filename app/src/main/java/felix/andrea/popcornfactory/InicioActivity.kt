...
class InicioActivity : AppCompatActivity() {
    ...
    private var moviesLista = ArrayList<Pelicula>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = PeliculaAdapter(this,moviesLista)
        grid_movies.adapter = adapter
        adapter = PeliculaAdapter(this,seriesLista)
        grid_series.adapter = adapter

    }

    fun cargaFilms(){
        seriesLista.add(Pelicula("Dr.House", R.drawable.drhouse,R.drawable.househeader,"The series follows the life of anti-social, pain killer addict, witty and arrogant medical doctor GregoryHouse (Hugh Laurie) with only half a muscle in his right leg. He and his team of medical doctors tryto cure complex and rare diseases from very ill ordinary people in the United States of America.The series follows the life of anti-social, pain killer addict, witty and arrogant medical doctor GregoryHouse (Hugh Laurie) with only half a muscle in his right leg. He and his team of medical doctors try to cure complex and rare diseases from very ill ordinary people in the United States of America.",arrayListOf<Cliente>()))
    ...
    class PeliculaAdapter: BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            vista.title_movie.text = pelicula.titulo
            vista.iv_movie.setImageResource(pelicula.image)

            vista.iv_movie.setOnClickListener {
